...
const  {generatePod, generateReplicatSet, generateDeployment, generateConfigMapFile, generateDataBaseFile, generateDeploymentFile, applyGeneratedK8sFiles}  = require('../controllers/Kubernetes-file-GeneratorController');
